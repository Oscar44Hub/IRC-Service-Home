...
export default function ApartamentoGallery() {
  ...
  return (
    <>
      <button
        type="button"
        aria-label={`Ver las ${totalPhotos} fotos de la reforma del apartamento en Madrid`}
      ...
      >
        <div className="aspect-[4/3] overflow-hidden bg-surface-alt">
          <img
            src={photos[0]}
            alt="Reforma integral de apartamento en Madrid capital ejecutada por IRC Service"
            width={1200}
            height={1600}
            loading="lazy"
            decoding="async"
